...
<body class="bg-gray-100 dark:bg-gray-900 h-full">
    <div class="flex flex-col w-full border-opacity-50 p-4 bg-gray-100 dark:bg-gray-900 h-full">
        <div class="grid card rounded-box bg-gray-900 dark:bg-gray-200 drop-shadow-xl z-40">
            <div class="navbar p-2 rounded-box w-full">
                <div class="navbar-start">
                    <div class="dropdown z-40">
                        ...
                        <ul tabindex="0"
                            class="menu menu-compact dropdown-content mt-3 p-5 w-96 shadow bg-gray-900 rounded-box dark:bg-gray-100 dark:text-gray-900">
                            <li>
                                <a href="{{ route('vacances.index') }}">Vacances</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('vacances.history') }}">Vacance History</a>
                            </li>
                        </ul>
                    </div>
                    <a href="{{ route('vacances.index') }}"
                        class="btn btn-ghost normal-case text-xl dark:text-gray-900">Vacances de travail</a>
                </div>
                <div class="navbar-center hidden lg:flex">
                    <ul class="menu menu-horizontal px-1 dark:text-gray-800">
                        <li>
                            <a href="{{ route('vacances.index') }}">Vacances</a>
                        </li>
                        <li>
                ...
                <div class="navbar-end">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button
                            class="flex items-center px-4 py-3 rounded-xl text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-800 active:bg-grey-900 focus:outline-none  transition-all">
        ...
        <div
            ...
            <div class="p-6">
                <span class="text-muted">© {{ date('Y') }} Vacance Management Application. Development by Aziz Samouh using Laravil.</span>
            </div>
        </div>
    </div>
    <script>
